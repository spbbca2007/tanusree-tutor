...
export const curriculum = {
  ...
  topics: [
    ...
    },
    {
      ...
      lessons: [{
        ...
        blocks: [
          ...
          { type: "example", title: "Working backwards — solving for the exponent", body: "Sometimes you're given the answer and asked to find the power. A bacteria colony starts at 1 and doubles every hour: 1, 2, 4, 8, 16, 32... After how many hours are there 32 bacteria?\n\nWrite it as an equation: 2^h = 32. Now count how many times you multiply by 2 to reach 32: 2×2×2×2×2 = 32, that's 5 twos, so h = 5.\n\nSame idea for any base: if 10^x = 100,000, just count the zeros — 5 zeros means x = 5." },
          { type: "tip", body: "Negative bases: an ODD exponent keeps the sign, an EVEN exponent always gives a positive result. (-4)³ = -4 × -4 × -4 = -64 (odd → stays negative). (-4)² = -4 × -4 = 16 (even → becomes positive)." }
        ],
        practice: [
          ...
          { id:"g7fmi-m07", tier:"medium", prompt:"84 juice bottles and 126 snack packs are shared into identical gift bags with none left over. What is the greatest number of gift bags possible?", options:["21","42","63","84"], answer:"42", hint:"This is asking for the HCF of 84 and 126.", explanation:"84=2²×3×7, 126=2×3²×7 → common factors 2×3×7=42", skill:"hcf-word-problems", misconception:"uses-lcm-instead-of-hcf" },
          { id:"g7fmi-m08", tier:"medium", prompt:"Buses seat either 18 or 24 people, with no seats empty either way. What is the smallest number of students that could be traveling?", options:["42","72","144","96"], answer:"72", hint:"Find the LCM of 18 and 24.", explanation:"18=2×3², 24=2³×3 → LCM=2³×3²=72", skill:"lcm-word-problems", misconception:"uses-hcf-instead-of-lcm" },
          { id:"g7fmi-m09", tier:"medium", prompt:"What is the HCF of any two consecutive whole numbers, like 20 and 21?", options:["1","2","Depends on the numbers","Their difference"], answer:"1", hint:"Try it: what factors could 20 and 21 possibly share?", explanation:"Consecutive numbers share no common factors other than 1, so their HCF is always 1.", skill:"hcf-conjectures", misconception:"assumes-consecutive-numbers-share-factors" },
          { id:"g7fmi-m10", tier:"medium", prompt:"37 and 47 are both prime numbers. What is their LCM?", options:["1","84","1739","37"], answer:"1739", hint:"For two primes, LCM = the two numbers multiplied together.", explanation:"37×47=1739 — since primes share no factors, their LCM is just their product.", skill:"lcm-hcf-of-primes", misconception:"confuses-hcf-and-lcm-of-primes" },
          { id:"g7fmi-m11", tier:"medium", prompt:"Is 10⁷ equal to one million?", options:["Yes, they're equal","No, 10⁷ is ten million","No, 10⁷ is one hundred million","No, 10⁷ is one hundred thousand"], answer:"No, 10⁷ is ten million", hint:"A million is 10⁶. Count the zeros in 10⁷.", explanation:"10⁶=1,000,000 (a million). 10⁷=10,000,000 (ten million) — one more zero, ten times bigger.", skill:"powers-of-ten", misconception:"miscounts-zeros-in-powers-of-ten" },
          { id:"g7fmi-m12", tier:"medium", prompt:"Work out (-4)³", options:["-64","64","-12","12"], answer:"-64", hint:"An odd number of negative signs multiplied together stays negative.", explanation:"(-4)×(-4)×(-4) = 16×(-4) = -64", skill:"negative-base-powers", misconception:"drops-the-negative-sign" },
          { id:"g7fmi-e11", tier:"easy",   prompt:"A bacteria colony starts with 1 bacterium and doubles every hour. How many bacteria are there after 5 hours?", options:["10","16","32","64"], answer:"32", hint:"Each hour, multiply by 2. That's 2⁵.", explanation:"2⁵=2×2×2×2×2=32", skill:"powers-as-repeated-growth", misconception:"adds-instead-of-multiplying-each-hour" },
          { id:"g7fmi-e12", tier:"easy",   prompt:"What power of 2 equals 16? (2^? = 16)", options:["3","4","5","8"], answer:"4", hint:"2×2×2×2=?", explanation:"2⁴=2×2×2×2=16", skill:"solve-for-exponent", misconception:"counts-multiplications-incorrectly" },
          { id:"g7fmi-e13", tier:"easy",   prompt:"What is x if 10ˣ = 100,000?", options:["4","5","6","10"], answer:"5", hint:"Count the zeros in 100,000.", explanation:"100,000 has 5 zeros, so 10⁵=100,000", skill:"solve-for-exponent", misconception:"miscounts-zeros" },
          { id:"g7fmi-h05", tier:"hard",   prompt:"Saplings must be planted in complete rows of 12, 15, or 40, with none left over regardless of which row size is chosen. What is the least number of saplings needed?", options:["120","60","480","600"], answer:"120", hint:"Find the LCM of 12, 15, and 40 — break each into primes first.", explanation:"12=2²×3, 15=3×5, 40=2³×5 → LCM=2³×3×5=120", skill:"lcm-word-problems", misconception:"multiplies-all-three-numbers-together" },
          { id:"g7fmi-h06", tier:"hard",   prompt:"What power of 7 equals 16,807? (7^? = 16807)", options:["4","5","6","3"], answer:"5", hint:"Multiply 7 by itself repeatedly: 7, 49, 343, 2401, 16807...", explanation:"7⁵=7×7×7×7×7=16807", skill:"solve-for-exponent", misconception:"guesses-without-checking" },
          { id:"g7fmi-h07", tier:"hard",   prompt:"Write 4³ as a power of 2", options:["2⁶","2⁷","2¹²","2⁵"], answer:"2⁶", hint:"First rewrite 4 as a power of 2 (4=2²), then use the power-of-a-power rule.", explanation:"4³=(2²)³=2^(2×3)=2⁶", skill:"power-of-power-base-conversion", misconception:"forgets-to-convert-base-first" },
          { id:"g7fmi-h08", tier:"hard",   prompt:"Mary and David think of the same number. David squares it, Mary cubes it. For which of these numbers would David's answer (squared) be GREATER than Mary's (cubed)?", options:["0.5","2","10","100"], answer:"0.5", hint:"Try each: for numbers between 0 and 1, cubing makes a number SMALLER than squaring does.", explanation:"0.5²=0.25, 0.5³=0.125 — squaring gives the bigger result. For numbers greater than 1, cubing overtakes squaring.", skill:"comparing-powers", misconception:"assumes-higher-power-always-gives-bigger-result" }
        ],
    ...
    {
      id: "g7-recurring-decimals", grade: 7, term: 1,
      realWorld: {"title": "Fraction to Decimal Detective", "emoji": "🔁", "task": "Pick 5 fractions (from a recipe, a sports score, or just make them up: 1/3, 2/7, 5/6...). Divide the numerator by the denominator on paper or a calculator. Which ones stop cleanly, and which ones go on forever with a repeating pattern? Circle the repeating digits.", "materials": "Calculator, notebook", "bringBack": "Your 5 fractions, their decimals, and which ones repeat."}, title: "Fractions & Recurring Decimals", emoji: "🔂",
      tagline: "When division doesn't end — and how to write it anyway", color: "topic-pink", difficulty: "core",
      lessons: [{
        id: "g7rd-1", title: "Converting fractions to decimals, and spotting the repeat",
        firstPrinciple: "Every fraction is really just a division: 1/3 means 1÷3. Sometimes that division ends cleanly (a terminating decimal, like 1/4=0.25). Sometimes it never ends but settles into a repeating pattern forever (a recurring decimal, like 1/3=0.333...). We write recurring decimals with a dot over the repeating digit(s) so we don't have to write dots forever.",
        blocks: [
          { type: "text", title: "Terminating vs recurring", body: "Divide numerator by denominator:\n1/4 = 1÷4 = 0.25 — stops. Terminating.\n1/3 = 1÷3 = 0.333... — never stops, repeats '3' forever. Recurring.\n2/7 = 2÷7 = 0.285714285714... — repeats the block '285714' forever.\n\nA fraction terminates ONLY if its denominator (in simplest form) has no prime factors other than 2 and 5." },
          { type: "example", title: "Recurring decimal notation", body: "Instead of writing 0.333... forever, we write 0.3̇ (a dot above the 3).\nFor a repeating BLOCK like 0.285714285714..., we put dots over the first and last digit of the block: 0.2̇85714̇\n\nThis is just shorthand — it means 'this pattern repeats forever', not 'multiply by 3'." },
          { type: "tip", body: "Quick check before dividing: look at the denominator. If, after simplifying the fraction, it only has 2s and 5s as prime factors (like 4=2×2, or 20=2×2×5), it WILL terminate. Anything else (3, 6, 7, 9, 11...) means it recurs." }
        ],
        practice: [
          { id:"g7rd-e01", tier:"easy",   prompt:"Convert 3/4 to a decimal",                   options:["0.75","0.34","0.43","1.33"],        answer:"0.75",  hint:"3÷4", explanation:"3÷4=0.75, terminates cleanly", skill:"fraction-to-decimal", misconception:"divides-wrong-way" },
          { id:"g7rd-e02", tier:"easy",   prompt:"Convert 1/3 to a decimal (as far as it goes)", options:["0.333...","0.3","0.33","3.0"],   answer:"0.333...", hint:"1÷3 never ends.", explanation:"1÷3=0.333... repeats forever", skill:"fraction-to-decimal", misconception:"rounds-instead-of-recognizing-repeat" },
          { id:"g7rd-e03", tier:"easy",   prompt:"Is 1/8 terminating or recurring?",           options:["Terminating","Recurring"],          answer:"Terminating", hint:"8=2×2×2 — only 2s as prime factors.", explanation:"8's only prime factor is 2, so 1/8=0.125 terminates", skill:"predict-terminating", misconception:"assumes-all-fractions-recur" },
          { id:"g7rd-e04", tier:"easy",   prompt:"Is 1/6 terminating or recurring?",           options:["Terminating","Recurring"],          answer:"Recurring", hint:"6=2×3 — there's a 3 in there.", explanation:"6 has a prime factor of 3 (not just 2s and 5s), so it recurs: 0.1666...", skill:"predict-terminating", misconception:"only-checks-if-denominator-is-even" },
          { id:"g7rd-e05", tier:"easy",   prompt:"Convert 1/5 to a decimal",                   options:["0.2","0.5","0.15","0.25"],          answer:"0.2",    hint:"1÷5", explanation:"1÷5=0.2", skill:"fraction-to-decimal", misconception:"arithmetic-slip" },
          { id:"g7rd-e06", tier:"easy",   prompt:"Convert 2/3 to a decimal (as far as it goes)", options:["0.666...","0.6","0.75","1.5"],   answer:"0.666...", hint:"2÷3 never ends.", explanation:"2÷3=0.666... repeats forever", skill:"fraction-to-decimal", misconception:"rounds-instead-of-recognizing-repeat" },
          { id:"g7rd-e07", tier:"easy",   prompt:"Which denominator guarantees a terminating decimal?",  options:["20","6","9","11"],   answer:"20",    hint:"20=2×2×5 — only 2s and 5s.", explanation:"20's prime factors are only 2 and 5", skill:"predict-terminating", misconception:"picks-based-on-being-even-only" },
          { id:"g7rd-e08", tier:"easy",   prompt:"Convert 7/10 to a decimal",                  options:["0.7","0.07","1.43","0.17"],         answer:"0.7",    hint:"7÷10", explanation:"7÷10=0.7", skill:"fraction-to-decimal", misconception:"misplaces-decimal-point" },
          { id:"g7rd-m01", tier:"medium", prompt:"Write 0.444... using recurring decimal notation", options:["0.4̇","4.0̇","0.44̇","0.4"],  answer:"0.4̇",   hint:"A single repeating digit gets one dot above it.", explanation:"0.444... = 0.4̇ (dot over the 4)", skill:"recurring-notation", misconception:"writes-as-terminating" },
          { id:"g7rd-m02", tier:"medium", prompt:"Convert 5/9 to a decimal (identify the repeating digit)", options:["0.5̇","0.5","0.45","0.59"], answer:"0.5̇", hint:"5÷9 = 0.555...", explanation:"5÷9=0.555...=0.5̇", skill:"fraction-to-decimal", misconception:"stops-dividing-too-early" },
          { id:"g7rd-m03", tier:"medium", prompt:"Which fraction converts to a recurring decimal?", options:["1/7","3/8","7/20","9/25"],  answer:"1/7",     hint:"Check the prime factors of each denominator.", explanation:"7 is prime and isn't 2 or 5, so 1/7 recurs. The others only have 2s/5s.", skill:"predict-terminating", misconception:"checks-numerator-not-denominator" },
          { id:"g7rd-m04", tier:"medium", prompt:"Convert 2/7 to a decimal and identify the repeating block", options:["0.2̇85714̇","0.285714","0.2857","0.28571428"], answer:"0.2̇85714̇", hint:"2÷7 repeats a 6-digit block.", explanation:"2÷7=0.285714285714...=0.2̇85714̇", skill:"recurring-notation", misconception:"doesnt-recognize-multi-digit-block" },
          { id:"g7rd-h01", tier:"hard",  prompt:"Without dividing, predict: does 7/16 terminate or recur?", options:["Terminating","Recurring"], answer:"Terminating", hint:"16=2×2×2×2 — only 2s.", explanation:"16's only prime factor is 2, so it terminates (7/16=0.4375)", skill:"predict-terminating", misconception:"assumes-large-denominators-always-recur" },
          { id:"g7rd-h02", tier:"hard",  prompt:"Convert 5/12 to a decimal — is it fully terminating, fully recurring, or mixed?", options:["Mixed (starts then repeats)","Fully terminating","Fully recurring from the start","Cannot be converted"], answer:"Mixed (starts then repeats)", hint:"12=2×2×3. The 2s let part terminate, the 3 forces a repeat.", explanation:"5/12=0.41666...=0.416̇ — starts with 41, then 6 repeats forever", skill:"mixed-recurring", misconception:"assumes-recurring-means-repeat-from-start" },
          { id:"g7rd-h03", tier:"hard",  prompt:"Which of these fractions, when simplified, has a denominator with a prime factor other than 2 or 5?", options:["7/21","9/45","4/16","10/50"], answer:"7/21", hint:"Simplify each fraction first, then check the denominator's prime factors.", explanation:"7/21 simplifies to 1/3 — denominator 3 isn't 2 or 5, so it recurs. The others simplify to denominators with only 2s/5s.", skill:"predict-terminating", misconception:"checks-before-simplifying" }
        ],
        challenge: { prompt:"A recipe needs 1/3 cup of sugar, but your measuring cup only has decimal markings. Which decimal should you use, and why can't you be perfectly exact?", options:["0.33 (an approximation — 1/3 never terminates)","0.3 exactly","0.333333 exactly","1/3 cannot be measured at all"], answer:"0.33 (an approximation — 1/3 never terminates)", explanation:"1/3=0.333... forever. Any decimal measurement is necessarily a rounded approximation, since the true value never terminates.", coach:"Recognize when a real-world tool (a measuring cup with fixed markings) can only approximate a recurring decimal, not represent it exactly." }
      }]
    },
    {
      id: "g7-mixed-fdp", grade: 7, term: 1,
      realWorld: {"title": "Recipe Scaler", "emoji": "🍳", "task": "Pick a recipe with mixed number quantities (e.g. 2 1/2 cups flour, 1 1/4 tsp salt). Scale the whole recipe to make double, or to serve 3 people instead of 4. Write out each new quantity as a mixed number.", "materials": "A recipe (from home or online), notebook", "bringBack": "Your original recipe and the scaled version, worked out by hand."}, title: "Mixed Numbers & Fraction-Decimal-Percent", emoji: "🥧",
      tagline: "Whole numbers and fractions together, and switching between forms", color: "topic-pink", difficulty: "core",
      lessons: [{
        id: "g7mfdp-1", title: "Adding mixed numbers and converting between fractions, decimals, and percentages",
        firstPrinciple: "A mixed number like 2 3/4 is a whole number plus a fraction. To add mixed numbers, add the whole number parts and the fraction parts separately, then combine — carrying over if the fraction part exceeds 1. Fractions, decimals, and percentages are three different costumes for the same value: 3/4 = 0.75 = 75%. Being able to switch between them fluently is the real skill.",
        blocks: [
          { type: "text", title: "Adding mixed numbers", body: "2 1/4 + 1 1/2:\nAdd whole numbers: 2+1=3\nAdd fractions: 1/4+1/2 = 1/4+2/4 = 3/4\nCombine: 3 3/4\n\nIf the fraction part goes over 1 (like 1/2+3/4=5/4), convert it: 5/4 = 1 1/4, then add that extra 1 to the whole number total." },
          { type: "example", title: "Converting between all three forms", body: "Fraction → Decimal: divide numerator by denominator. 3/5 = 3÷5 = 0.6\nDecimal → Percentage: multiply by 100. 0.6 × 100 = 60%\nPercentage → Fraction: put over 100, simplify. 60% = 60/100 = 3/5\n\nThey're the same value, three different outfits — pick whichever is easiest for the situation." },
          { type: "tip", body: "Common mistake with mixed number fractions: 3/4 + 1/2 is NOT 4/6. You must find a common denominator first (3/4 + 2/4 = 5/4), never just add numerators and denominators straight across." }
        ],
        practice: [
          { id:"g7mfdp-e01", tier:"easy",   prompt:"Add: 2 1/4 + 1 1/4",                        options:["3 1/2","3 2/4","4","3"],             answer:"3 1/2",  hint:"Whole+whole, fraction+fraction.", explanation:"2+1=3, 1/4+1/4=2/4=1/2. Total: 3 1/2", skill:"add-mixed-numbers", misconception:"adds-numerators-and-denominators-straight-across" },
          { id:"g7mfdp-e02", tier:"easy",   prompt:"Convert 3/4 to a decimal",                   options:["0.75","0.34","0.43","3.4"],           answer:"0.75",    hint:"3÷4", explanation:"3÷4=0.75", skill:"fraction-to-decimal", misconception:"arithmetic-slip" },
          { id:"g7mfdp-e03", tier:"easy",   prompt:"Convert 0.6 to a percentage",                options:["60%","6%","0.6%","600%"],             answer:"60%",     hint:"Multiply by 100.", explanation:"0.6×100=60%", skill:"decimal-to-percent", misconception:"forgets-to-multiply-by-100" },
          { id:"g7mfdp-e04", tier:"easy",   prompt:"Convert 45% to a fraction (simplified)",     options:["9/20","45/100","4/5","9/10"],         answer:"9/20",    hint:"45/100, then simplify.", explanation:"45/100 simplifies (÷5) to 9/20", skill:"percent-to-fraction", misconception:"leaves-fraction-unsimplified" },
          { id:"g7mfdp-e05", tier:"easy",   prompt:"Add: 1 1/2 + 2 1/2",                        options:["4","3 2/2","3 1/2","4 1/2"],           answer:"4",       hint:"1/2+1/2=1 whole — carry it over.", explanation:"1+2=3 wholes. 1/2+1/2=1 whole. 3+1=4", skill:"add-mixed-numbers-carrying", misconception:"forgets-to-carry-over-whole" },
          { id:"g7mfdp-e06", tier:"easy",   prompt:"Convert 1/4 to a percentage",                options:["25%","4%","40%","14%"],               answer:"25%",     hint:"1÷4=0.25, then ×100.", explanation:"1/4=0.25=25%", skill:"fraction-to-percent", misconception:"skips-decimal-step" },
          { id:"g7mfdp-e07", tier:"easy",   prompt:"Convert 0.05 to a percentage",               options:["5%","0.5%","50%","0.05%"],            answer:"5%",      hint:"Multiply by 100.", explanation:"0.05×100=5%", skill:"decimal-to-percent", misconception:"misplaces-decimal-point" },
          { id:"g7mfdp-e08", tier:"easy",   prompt:"Add: 3 1/3 + 1 1/3",                        options:["4 2/3","5","4 1/3","5 2/3"],           answer:"4 2/3",   hint:"3+1=4 wholes, 1/3+1/3=2/3.", explanation:"4 wholes + 2/3 = 4 2/3", skill:"add-mixed-numbers", misconception:"adds-numerators-and-denominators-straight-across" },
          { id:"g7mfdp-m01", tier:"medium", prompt:"Add: 2 3/4 + 1 1/2",                         options:["4 1/4","3 4/6","4","3 1/4"],           answer:"4 1/4",   hint:"3/4+1/2=3/4+2/4=5/4, which is 1 1/4 — carry it.", explanation:"2+1=3 wholes. 3/4+2/4=5/4=1 1/4. 3+1 1/4=4 1/4", skill:"add-mixed-numbers-carrying", misconception:"forgets-common-denominator" },
          { id:"g7mfdp-m02", tier:"medium", prompt:"Which of these is NOT equal to the others?", options:["3/5","0.6","60%","6/5"],               answer:"6/5",     hint:"Convert each to a decimal and compare.", explanation:"3/5=0.6=60%, but 6/5=1.2 — a different value entirely", skill:"equivalence-check", misconception:"doesnt-verify-across-all-forms" },
          { id:"g7mfdp-m03", tier:"medium", prompt:"A recipe needs 1 1/2 cups flour. You're making 1.5x the recipe. How much flour now?", options:["2 1/4 cups","3 cups","2 cups","1 3/4 cups"], answer:"2 1/4 cups", hint:"1 1/2 × 1.5 — try converting 1 1/2 to 1.5 first.", explanation:"1 1/2=1.5. 1.5×1.5=2.25=2 1/4 cups", skill:"scale-mixed-numbers", misconception:"multiplies-whole-and-fraction-separately-incorrectly" },
          { id:"g7mfdp-h01", tier:"hard",  prompt:"Add: 4 2/3 + 2 5/6",                         options:["7 1/2","6 7/6","7","6 1/2"],            answer:"7 1/2",   hint:"Common denominator for 3 and 6 is 6: 2/3=4/6.", explanation:"4+2=6 wholes. 4/6+5/6=9/6=1 3/6=1 1/2. 6+1 1/2=7 1/2", skill:"add-mixed-numbers-different-denominators", misconception:"adds-fractions-without-common-denominator" },
          { id:"g7mfdp-h02", tier:"hard",  prompt:"Order from smallest to largest: 7/10, 68%, 0.72, 3/4", options:["7/10, 68%, 0.72, 3/4","68%, 7/10, 0.72, 3/4","3/4, 0.72, 68%, 7/10","7/10, 0.72, 68%, 3/4"], answer:"68%, 7/10, 0.72, 3/4", hint:"Convert all to decimals first: 0.7, 0.68, 0.72, 0.75.", explanation:"68%=0.68, 7/10=0.7, 0.72=0.72, 3/4=0.75. Ordered: 0.68<0.7<0.72<0.75", skill:"compare-mixed-forms", misconception:"compares-without-converting-to-common-form" },
          { id:"g7mfdp-h03", tier:"hard",  prompt:"A tank is 5/8 full. After adding 1 1/4 more tanks worth, how full is it (as a fraction, allowing over 1 whole tank)?", options:["1 7/8","1 1/2","2","1 5/8"], answer:"1 7/8", hint:"5/8 + 1 1/4. Convert 1 1/4 to eighths: 1 2/8.", explanation:"5/8 + 1 2/8 = 1 7/8 tanks", skill:"add-mixed-numbers-different-denominators", misconception:"doesnt-convert-to-common-denominator-before-adding" }
        ],
        challenge: { prompt:"You've used 2 1/3 liters of a 5-liter paint can. Is what's left more or less than half the can, and by how much as a fraction?", options:["More than half, by 1/6 liter","Less than half","Exactly half","Cannot compare fractions and liters"], answer:"More than half, by 1/6 liter", explanation:"Used: 2 1/3L. Remaining: 5-2 1/3=2 2/3L. Half of 5L is 2 1/2L. 2 2/3L is more, by 2 2/3-2 1/2=1/6 liter.", coach:"Convert everything to a common form (like a common fraction denominator) before comparing." }
      }]
    },
    {
      id: "g7-algebra-expand", grade: 7, term: 1,
      realWorld: {"title": "Pattern Builder", "emoji": "🧱", "task": "Using matchsticks, coins, or LEGO bricks, build a growing pattern (e.g. each 'step' adds 3 more pieces). Write an algebraic expression for the number of pieces at step n. Then expand or simplify it if needed, and check it against step 5 by actually counting.", "materials": "Matchsticks, coins, or building blocks, notebook", "bringBack": "Your pattern, your expression, and the check against a physical count."}, title: "Algebra: Grouping & Expanding", emoji: "🔤",
      tagline: "Simplifying expressions and multiplying out brackets", color: "topic-orange", difficulty: "core",
      lessons: [{
        id: "g7alg-1", title: "Collecting like terms and expanding brackets",
        firstPrinciple: "In algebra, 'like terms' are terms with exactly the same letter part (3x and 5x are like terms; 3x and 3x² are not). You can only add or subtract like terms directly, the same way you can only add apples to apples, not apples to oranges. Expanding brackets means multiplying everything inside the bracket by whatever's outside it — every single term inside, not just the first one.",
        blocks: [
          { type: "text", title: "Collecting like terms", body: "Group matching letter-parts together:\n3x + 5x = 8x (both are 'x' terms)\n7y - 2y = 5y\n3x + 5x + 2y - y = 8x + y (x terms together, y terms together)\n\n3x and 3x² are NOT like terms — different powers of x count as different types entirely." },
          { type: "example", title: "Expanding a bracket", body: "3(x + 4) means 3 multiplied by EVERYTHING inside:\n3(x + 4) = 3×x + 3×4 = 3x + 12\n\nWith a negative outside: -2(x - 5) = -2×x + -2×(-5) = -2x + 10\n(Careful — the sign flips when multiplying by a negative!)" },
          { type: "tip", body: "The most common mistake: multiplying only the FIRST term inside the bracket and forgetting the rest. 3(x+4) is NOT 3x+4 — the 3 must hit the 4 as well, giving 3x+12." }
        ],
        practice: [
          { id:"g7alg-e01", tier:"easy",   prompt:"Simplify: 4x + 3x",                          options:["7x","12x","7x²","4x3x"],              answer:"7x",       hint:"Same letter — just add the numbers in front.", explanation:"4x+3x=7x", skill:"collect-like-terms", misconception:"multiplies-instead-of-adds" },
          { id:"g7alg-e02", tier:"easy",   prompt:"Simplify: 8y - 3y",                          options:["5y","11y","5","24y"],                 answer:"5y",       hint:"Subtract the numbers in front.", explanation:"8y-3y=5y", skill:"collect-like-terms", misconception:"arithmetic-slip" },
          { id:"g7alg-e03", tier:"easy",   prompt:"Expand: 2(x + 5)",                           options:["2x+10","2x+5","x+10","2x+7"],          answer:"2x+10",    hint:"Multiply BOTH terms inside by 2.", explanation:"2×x+2×5=2x+10", skill:"expand-brackets", misconception:"only-multiplies-first-term" },
          { id:"g7alg-e04", tier:"easy",   prompt:"Expand: 3(y - 2)",                           options:["3y-6","3y-2","y-6","3y-5"],            answer:"3y-6",     hint:"Multiply both terms by 3.", explanation:"3×y+3×(-2)=3y-6", skill:"expand-brackets", misconception:"only-multiplies-first-term" },
          { id:"g7alg-e05", tier:"easy",   prompt:"Simplify: 5x + 2x + 3x",                     options:["10x","10x³","30x","15x"],             answer:"10x",      hint:"All the same letter — add all the numbers.", explanation:"5+2+3=10, so 10x", skill:"collect-like-terms", misconception:"loses-track-of-a-term" },
          { id:"g7alg-e06", tier:"easy",   prompt:"Simplify: 6x + 2y - 2x + y",                 options:["4x+3y","8x+3y","4x+y","4xy"],         answer:"4x+3y",    hint:"Group x terms together, y terms together.", explanation:"6x-2x=4x. 2y+y=3y. Total: 4x+3y", skill:"collect-like-terms", misconception:"combines-different-letter-terms" },
          { id:"g7alg-e07", tier:"easy",   prompt:"Expand: 4(x + 1)",                           options:["4x+4","4x+1","x+4","4x+5"],            answer:"4x+4",     hint:"Multiply both terms by 4.", explanation:"4×x+4×1=4x+4", skill:"expand-brackets", misconception:"only-multiplies-first-term" },
          { id:"g7alg-e08", tier:"easy",   prompt:"Simplify: 9x - 4x + x",                      options:["6x","4x","5x","13x"],                  answer:"6x",       hint:"Remember: 'x' alone means '1x'.", explanation:"9-4+1=6, so 6x", skill:"collect-like-terms", misconception:"forgets-lone-x-means-1x" },
          { id:"g7alg-m01", tier:"medium", prompt:"Expand: -2(x + 3)",                          options:["-2x-6","-2x+6","2x-6","-2x-3"],        answer:"-2x-6",    hint:"Negative times positive = negative, for both terms.", explanation:"-2×x+-2×3=-2x-6", skill:"expand-negative-brackets", misconception:"only-negates-first-term" },
          { id:"g7alg-m02", tier:"medium", prompt:"Expand: -3(x - 4)",                          options:["-3x+12","-3x-12","3x-12","-3x-4"],     answer:"-3x+12",   hint:"Negative times negative = positive.", explanation:"-3×x+(-3)×(-4)=-3x+12", skill:"expand-negative-brackets", misconception:"doesnt-flip-sign-on-second-term" },
          { id:"g7alg-m03", tier:"medium", prompt:"Expand and simplify: 2(x+3) + 3(x+1)",       options:["5x+9","5x+4","6x+9","5x+3"],            answer:"5x+9",     hint:"Expand each bracket first, then collect like terms.", explanation:"2x+6+3x+3=5x+9", skill:"expand-and-combine", misconception:"forgets-to-collect-after-expanding" },
          { id:"g7alg-h01", tier:"hard",  prompt:"Expand and simplify: 4(x+2) - 2(x-1)",        options:["2x+10","2x+6","6x+6","2x+9"],           answer:"2x+10",    hint:"Expand both, watch the sign when subtracting the second bracket.", explanation:"4x+8-2x+2=2x+10 (careful: -2×(-1)=+2)", skill:"expand-and-combine-with-subtraction", misconception:"doesnt-distribute-negative-across-second-bracket" },
          { id:"g7alg-h02", tier:"hard",  prompt:"A rectangle has width x and length (x+5). Write its perimeter, fully expanded and simplified.", options:["4x+10","2x+5","4x+5","x²+5x"], answer:"4x+10", hint:"Perimeter=2(width+length)=2(x+(x+5)).", explanation:"2(x+x+5)=2(2x+5)=4x+10", skill:"apply-expanding-word-problem", misconception:"confuses-perimeter-with-area-formula" },
          { id:"g7alg-h03", tier:"hard",  prompt:"Simplify: 3(2x+1) - (x+4)",                   options:["5x-1","5x+7","7x-1","5x-4"],             answer:"5x-1",     hint:"The bracket with no number in front still means ×1 — and it's being subtracted.", explanation:"6x+3-x-4=5x-1", skill:"expand-and-combine-with-subtraction", misconception:"forgets-implicit-negative-one-multiplier" }
        ],
        challenge: { prompt:"Simplify fully: 2(3x - 1) + 4(x + 2) - 3(x - 1)", options:["7x+9","11x+9","5x+9","11x+3"], answer:"7x+9", explanation:"Expand each: 6x-2, 4x+8, -3x+3. Combine x terms: 6x+4x-3x=7x. Combine numbers: -2+8+3=9. Result: 7x+9.", coach:"Expand one bracket at a time, writing out every term before combining anything — rushing to combine early is where mistakes creep in." }
      }]
    }
  ]
};
...
export const bankKeyForTopic = {
  ...
  "g7-recurring-decimals":"g7-recurring-decimals", "g7-mixed-fdp":"g7-mixed-fdp",
  "g7-algebra-expand":"g7-algebra-expand"
};
